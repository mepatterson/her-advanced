module HerAdvanced
  # This class is where all HTTP requests are made. Before using HerAdvanced, you must configure it
  ...
  class API
    ...
    # If your application uses only one API, you should use HerAdvanced::API.setup to configure the default API
    #
    # @example Setting up a new API
    #   api = HerAdvanced::API.new :url => "https://api.example" do |connection|
    #     connection.use Faraday::Request::UrlEncoded
    #     connection.use HerAdvanced::Middleware::DefaultParseJSON
    #   end
    #
    #   class User
    #     uses_api api
    ...
    #   HerAdvanced::API.setup :url => "https://api.example"
    #
