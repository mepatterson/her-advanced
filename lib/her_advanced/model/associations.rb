require "her_advanced/model/associations/association"
require "her_advanced/model/associations/association_proxy"
require "her_advanced/model/associations/belongs_to_association"
require "her_advanced/model/associations/has_many_association"
require "her_advanced/model/associations/has_one_association"
    ...
    module Associations
      ...
      module ClassMethods
        ...
        def parse_associations(data)
          associations.each_pair do |type, definitions|
            definitions.each do |association|
              association_class = "her_advanced/model/associations/#{type}_association".classify.constantize
        ...
        def has_many(name, opts={})
          HerAdvanced::Model::Associations::HasManyAssociation.attach(self, name, opts)
        end
        ...
        def belongs_to(name, opts={})
          HerAdvanced::Model::Associations::BelongsToAssociation.attach(self, name, opts)
        end
      end
    end
  end
