  ...
  module Model
    ...
    module Attributes
      ...
      def self.initialize_collection(klass, parsed_data={})
        ...
        HerAdvanced::Collection.new(collection_data, parsed_data[:metadata], parsed_data[:errors])
      end
      ...
      def assign_attributes(new_attributes)
        ...
        unset_attributes = HerAdvanced::Model::Attributes.use_setter_methods(self, new_attributes)
      ...
      # Return `true` if the other object is also a HerAdvanced::Model and has matching data
      #
      # @private
      def ==(other)
        other.is_a?(HerAdvanced::Model) && @attributes == other.attributes
      end
      ...
      module ClassMethods
        ...
        def new_collection(parsed_data)
          HerAdvanced::Model::Attributes.initialize_collection(self, parsed_data)
        end
