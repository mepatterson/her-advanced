      ...
      module ClassMethods
        ...
        def build_request_path(path=nil, parameters={})
          ...
          path.gsub(/:([\w_]+)/) do
            ...
            value = $1.to_sym
            parameters.delete(value) || parameters.delete(:"_#{value}") || raise(HerAdvanced::Errors::PathError.new("Missing :_#{$1} parameter to build the request path. Path is `#{path}`. Parameters are `#{parameters.symbolize_keys.inspect}`.", $1))
          end
        end
