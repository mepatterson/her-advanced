module HerAdvanced
  module Model
    # This module interacts with HerAdvanced::API to fetch HTTP data
    module HTTP
      ...
      module ClassMethods
        ...
        #
        # @example
        #   secondary_api = HerAdvanced::API.new :url => "https://api.example" do |connection|
        ...
        # Main request wrapper around HerAdvanced::API. Used to make custom request to the API.
        #
        # @private
        def request(params={})
