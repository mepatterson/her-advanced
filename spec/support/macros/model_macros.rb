module HerAdvanced
  module Testing
    module Macros
      module ModelMacros
        # Create a class and automatically inject HerAdvanced::Model into it
        def spawn_model(klass, &block)
          if klass =~ /::/
            ...
            Object.const_get(base).module_eval do
              ...
              submodel.send(:include, HerAdvanced::Model)
            ...
            Object.const_set(klass, Class.new).send(:include, HerAdvanced::Model)
